...
class BillingController:
    ...
    def mark_as_paid(self, bill_id, request):
        try:
            ...
            # Notification endpoint was removed from patient-service
            # Patient notification functionality temporarily disabled
            print(f"Patient notification skipped - endpoint removed: bill #{bill_id}")
