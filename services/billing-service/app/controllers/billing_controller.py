...
class BillingController:
    ...
    def mark_as_paid(self, bill_id, request):
        try:
            ...
            # Patient notification endpoint was removed
            # Patient notification should now be handled by another mechanism
            print(f"Patient notification would have been sent for bill #{bill_id}")
            # In a real implementation, this might use a message queue or email service
