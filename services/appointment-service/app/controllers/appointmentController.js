	...
	async create(req, res) {
		try {
			...
			if (!patient_id || !doctor_id || !appointment_date || !appointment_time) {
                ...
                // Patient verification skipped due to removed patient service GET endpoint
	...
	async getById(req, res) {
		try {
			...
			if (!appointment) {
                ...
                // Patient details enrichment skipped due to removed patient service GET endpoint
