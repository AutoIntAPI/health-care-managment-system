...
@patient_bp.route('/<int:patients_id>', methods=['GET'])
...
@patient_bp.route('/<int:patients_id>', methods=['PUT'])
def update_patient(patient_id):
    return controller.update(patient_id, request)

@patient_bp.route('/<int:patients_id>', methods=['DELETE'])
def delete_patient(patient_id):
    return controller.delete(patient_id)

@patient_bp.route('/<int:patient_id>/notifi', methods=['POST'])
